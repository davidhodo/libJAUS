#ifndef URN_JAUS_JSS_MOBILITY_LOCALVECTORDRIVER_1_0_REPORTLOCALVECTOR_H
#define URN_JAUS_JSS_MOBILITY_LOCALVECTORDRIVER_1_0_REPORTLOCALVECTOR_H
...
class DllExport ReportLocalVector: public JTS::Message
{
public:
	static const int ID = 0x4408;
	...
	virtual void encode(unsigned char *bytes);
	virtual void decode(const unsigned char *bytes);
	ReportLocalVector &operator=(const ReportLocalVector &value);
	bool operator==(const ReportLocalVector &value) const;
	bool operator!=(const ReportLocalVector &value) const;
	ReportLocalVector();
	ReportLocalVector(const ReportLocalVector &value);
...
#endif // URN_JAUS_JSS_MOBILITY_LOCALVECTORDRIVER_1_0_REPORTLOCALVECTOR_H
