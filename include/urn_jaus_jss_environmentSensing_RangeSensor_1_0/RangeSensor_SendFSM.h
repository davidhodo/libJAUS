...
#ifndef RANGESENSOR_SENDFSM_H
#define RANGESENSOR_SENDFSM_H
...
#include "RangeSensor_SendFSM_sm.h"

namespace urn_jaus_jss_environmentSensing_RangeSensor_1_0
{
	
class DllExport RangeSensor_SendFSM : public JTS::StateMachine
{
public:
	RangeSensor_SendFSM(urn_jaus_jss_core_Transport_1_0::Transport_SendFSM* pTransport_SendFSM, urn_jaus_jss_core_Events_1_0::Events_SendFSM* pEvents_SendFSM, urn_jaus_jss_core_AccessControl_1_0::AccessControl_SendFSM* pAccessControl_SendFSM);
	virtual ~RangeSensor_SendFSM();
	...
	RangeSensor_SendFSMContext *context;
