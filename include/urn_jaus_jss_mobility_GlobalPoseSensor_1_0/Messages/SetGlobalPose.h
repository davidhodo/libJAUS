#ifndef URN_JAUS_JSS_MOBILITY_GLOBALPOSESENSOR_1_0_SETGLOBALPOSE_H
#define URN_JAUS_JSS_MOBILITY_GLOBALPOSESENSOR_1_0_SETGLOBALPOSE_H
...
class DllExport SetGlobalPose: public JTS::Message
{
public:
	static const int ID = 0x0402;
	...
	virtual void encode(unsigned char *bytes);
	virtual void decode(const unsigned char *bytes);
	SetGlobalPose &operator=(const SetGlobalPose &value);
	bool operator==(const SetGlobalPose &value) const;
	bool operator!=(const SetGlobalPose &value) const;
	SetGlobalPose();
	SetGlobalPose(const SetGlobalPose &value);
	virtual ~SetGlobalPose();
...
#endif // URN_JAUS_JSS_MOBILITY_GLOBALPOSESENSOR_1_0_SETGLOBALPOSE_H
