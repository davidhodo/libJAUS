#ifndef URN_JAUS_JSS_MOBILITY_GLOBALVECTORDRIVER_1_0_SETGLOBALVECTOR_H
#define URN_JAUS_JSS_MOBILITY_GLOBALVECTORDRIVER_1_0_SETGLOBALVECTOR_H
...
class DllExport SetGlobalVector: public JTS::Message
{
public:
	static const int ID = 0x0407;
	...
	virtual void encode(unsigned char *bytes);
	virtual void decode(const unsigned char *bytes);
	SetGlobalVector &operator=(const SetGlobalVector &value);
	bool operator==(const SetGlobalVector &value) const;
	bool operator!=(const SetGlobalVector &value) const;
	SetGlobalVector();
	SetGlobalVector(const SetGlobalVector &value);
...
#endif // URN_JAUS_JSS_MOBILITY_GLOBALVECTORDRIVER_1_0_SETGLOBALVECTOR_H
