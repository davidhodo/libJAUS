#ifndef URN_JAUS_JSS_MOBILITY_PRIMITIVEDRIVER_1_0_SETWRENCHEFFORT_H
#define URN_JAUS_JSS_MOBILITY_PRIMITIVEDRIVER_1_0_SETWRENCHEFFORT_H
...
class DllExport SetWrenchEffort: public JTS::Message
{
public:
	static const int ID = 0x0405;
	...
	virtual void encode(unsigned char *bytes);
	virtual void decode(const unsigned char *bytes);
	SetWrenchEffort &operator=(const SetWrenchEffort &value);
	bool operator==(const SetWrenchEffort &value) const;
	bool operator!=(const SetWrenchEffort &value) const;
	SetWrenchEffort();
	SetWrenchEffort(const SetWrenchEffort &value);
...
#endif // URN_JAUS_JSS_MOBILITY_PRIMITIVEDRIVER_1_0_SETWRENCHEFFORT_H
