...
void VisualSensor_ReceiveFSM::SendAction(std::string arg0, Receive::Body::ReceiveRec transportData)
{
	/// Insert User Code HERE
}

void VisualSensor_ReceiveFSM::updateVisualSensorConfigurationAction()
{
	/// Insert User Code HERE
}
