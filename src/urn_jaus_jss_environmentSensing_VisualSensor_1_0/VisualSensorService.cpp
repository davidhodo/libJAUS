...
bool VisualSensorService::processTransitions(InternalEvent* ie)
{
   ...
   mutex.lock();
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_VisualSensor_ReceiveFSM_Receiving_Ready_Controlled") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Receive") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_VisualSensor_ReceiveFSM_Receiving_Ready_NotControlled") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_VisualSensor_ReceiveFSM_Receiving_Ready") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_VisualSensor_ReceiveFSM_Receiving") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
...
bool VisualSensorService::defaultTransitions(InternalEvent* ie)
{
   ...
   mutex.lock();
			...
			try
			{
				if ((done == false) && ie->getName().compare("Timeout") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventOccurred") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventError") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Send") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastLocal") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastGlobal") == 0 && (ie->getSource().compare("VisualSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Receive") == 0 && (ie->getSource().compare("VisualSensor_SendFSM") != 0))
				{
					Receive* casted_ie = (Receive*) ie;
					unsigned short id = *((unsigned short*) casted_ie->getBody()->getReceiveRec()->getMessagePayload()->getData());
					if ( id == QuerySensorGeometricProperties::ID)
			...
			try
			{
				if ((done == false) && ie->getName().compare("Timeout") == 0 && (ie->getSource().compare("VisualSensor_SendFSM") != 0))
				{
					Timeout* casted_ie = (Timeout*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventOccurred") == 0 && (ie->getSource().compare("VisualSensor_SendFSM") != 0))
				{
					EventOccurred* casted_ie = (EventOccurred*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventError") == 0 && (ie->getSource().compare("VisualSensor_SendFSM") != 0))
				{
					EventError* casted_ie = (EventError*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("Send") == 0 && (ie->getSource().compare("VisualSensor_SendFSM") != 0))
				{
					Send* casted_ie = (Send*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastLocal") == 0 && (ie->getSource().compare("VisualSensor_SendFSM") != 0))
				{
					BroadcastLocal* casted_ie = (BroadcastLocal*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastGlobal") == 0 && (ie->getSource().compare("VisualSensor_SendFSM") != 0))
				{
					BroadcastGlobal* casted_ie = (BroadcastGlobal*) ie;
