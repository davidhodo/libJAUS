...
VelocityStateSensorService::VelocityStateSensorService(JTS::JausRouter* jausRouter , urn_jaus_jss_core_Transport_1_0::TransportService* pTransportService, urn_jaus_jss_core_Events_1_0::EventsService* pEventsService) : Service()
{
	...
	pVelocityStateSensor_ReceiveFSM->setHandlers(ieHandler, jausRouter);
	...
	pVelocityStateSensor_SendFSM->setHandlers(ieHandler, jausRouter);
...
{
	delete pVelocityStateSensor_ReceiveFSM;
	delete pVelocityStateSensor_SendFSM;
...
bool VelocityStateSensorService::processTransitions(InternalEvent* ie)
{
   ...
   mutex.lock();
			...
			try
			{
				if ((done == false) && ie->getName().compare("Receive") == 0 && (ie->getSource().compare("VelocityStateSensor_ReceiveFSM") != 0))
				{
...
bool VelocityStateSensorService::defaultTransitions(InternalEvent* ie)
{
   ...
   mutex.lock();
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventOccurred") == 0 && (ie->getSource().compare("VelocityStateSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventError") == 0 && (ie->getSource().compare("VelocityStateSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Send") == 0 && (ie->getSource().compare("VelocityStateSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastLocal") == 0 && (ie->getSource().compare("VelocityStateSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastGlobal") == 0 && (ie->getSource().compare("VelocityStateSensor_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Receive") == 0 && (ie->getSource().compare("VelocityStateSensor_SendFSM") != 0))
				{
					Receive* casted_ie = (Receive*) ie;
					unsigned short id = *((unsigned short*) casted_ie->getBody()->getReceiveRec()->getMessagePayload()->getData());
					if ( id == QueryVelocityState::ID)
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventOccurred") == 0 && (ie->getSource().compare("VelocityStateSensor_SendFSM") != 0))
				{
					EventOccurred* casted_ie = (EventOccurred*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventError") == 0 && (ie->getSource().compare("VelocityStateSensor_SendFSM") != 0))
				{
					EventError* casted_ie = (EventError*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("Send") == 0 && (ie->getSource().compare("VelocityStateSensor_SendFSM") != 0))
				{
					Send* casted_ie = (Send*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastLocal") == 0 && (ie->getSource().compare("VelocityStateSensor_SendFSM") != 0))
				{
					BroadcastLocal* casted_ie = (BroadcastLocal*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastGlobal") == 0 && (ie->getSource().compare("VelocityStateSensor_SendFSM") != 0))
				{
					BroadcastGlobal* casted_ie = (BroadcastGlobal*) ie;
