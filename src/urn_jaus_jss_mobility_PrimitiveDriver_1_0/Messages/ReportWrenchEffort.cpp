#include "urn_jaus_jss_mobility_PrimitiveDriver_1_0/Messages/ReportWrenchEffort.h"

namespace urn_jaus_jss_mobility_PrimitiveDriver_1_0
{

void ReportWrenchEffort::AppHeader::HeaderRec::setParent(AppHeader* parent)
{
	m_parent = parent;
}

void ReportWrenchEffort::AppHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger ReportWrenchEffort::AppHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int ReportWrenchEffort::AppHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int ReportWrenchEffort::AppHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void ReportWrenchEffort::AppHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void ReportWrenchEffort::AppHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
ReportWrenchEffort::AppHeader::HeaderRec &ReportWrenchEffort::AppHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool ReportWrenchEffort::AppHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
ReportWrenchEffort::AppHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x4405;
}

ReportWrenchEffort::AppHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
ReportWrenchEffort::AppHeader::HeaderRec* const ReportWrenchEffort::AppHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int ReportWrenchEffort::AppHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void ReportWrenchEffort::AppHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int ReportWrenchEffort::AppHeader::getSize()
{
	unsigned int size = 0;
...
void ReportWrenchEffort::AppHeader::encode(unsigned char *bytes)
{
...
void ReportWrenchEffort::AppHeader::decode(const unsigned char *bytes)
{
...
ReportWrenchEffort::AppHeader &ReportWrenchEffort::AppHeader::operator=(const AppHeader &value)
{
...
bool ReportWrenchEffort::AppHeader::operator==(const AppHeader &value) const
{
...
ReportWrenchEffort::AppHeader::AppHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

ReportWrenchEffort::AppHeader::AppHeader(const AppHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
ReportWrenchEffort::AppHeader* const ReportWrenchEffort::getAppHeader()
{
	return &m_AppHeader;
}

int ReportWrenchEffort::setAppHeader(const AppHeader &value)
{
	m_AppHeader = value;
	return 0;
}
