...
bool LocalWaypointListDriverService::processTransitions(InternalEvent* ie)
{
   ...
   mutex.lock();
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_StateA_Standby") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_StateA_Failure") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_StateA_Shutdown") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_StateA_Emergency") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_Controlled_StateB_Standby") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_Controlled_StateB_Ready") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_Controlled_StateB_Emergency") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_Controlled_StateB") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_Controlled") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_StateA_Init") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_StateA") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Receive") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
...
bool LocalWaypointListDriverService::defaultTransitions(InternalEvent* ie)
{
   ...
   mutex.lock();
			...
			try
			{
				if ((done == false) && ie->getName().compare("Initialized") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Failure") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Timeout") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventOccurred") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventError") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Send") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastLocal") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastGlobal") == 0 && (ie->getSource().compare("LocalWaypointListDriver_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Receive") == 0 && (ie->getSource().compare("LocalWaypointListDriver_SendFSM") != 0))
				{
					Receive* casted_ie = (Receive*) ie;
					unsigned short id = *((unsigned short*) casted_ie->getBody()->getReceiveRec()->getMessagePayload()->getData());
					if ( id == ExecuteList::ID)
			...
			try
			{
				if ((done == false) && ie->getName().compare("Initialized") == 0 && (ie->getSource().compare("LocalWaypointListDriver_SendFSM") != 0))
				{
					Initialized* casted_ie = (Initialized*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("Failure") == 0 && (ie->getSource().compare("LocalWaypointListDriver_SendFSM") != 0))
				{
					Failure* casted_ie = (Failure*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("Timeout") == 0 && (ie->getSource().compare("LocalWaypointListDriver_SendFSM") != 0))
				{
					Timeout* casted_ie = (Timeout*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventOccurred") == 0 && (ie->getSource().compare("LocalWaypointListDriver_SendFSM") != 0))
				{
					EventOccurred* casted_ie = (EventOccurred*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("EventError") == 0 && (ie->getSource().compare("LocalWaypointListDriver_SendFSM") != 0))
				{
					EventError* casted_ie = (EventError*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("Send") == 0 && (ie->getSource().compare("LocalWaypointListDriver_SendFSM") != 0))
				{
					Send* casted_ie = (Send*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastLocal") == 0 && (ie->getSource().compare("LocalWaypointListDriver_SendFSM") != 0))
				{
					BroadcastLocal* casted_ie = (BroadcastLocal*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("BroadcastGlobal") == 0 && (ie->getSource().compare("LocalWaypointListDriver_SendFSM") != 0))
				{
					BroadcastGlobal* casted_ie = (BroadcastGlobal*) ie;
