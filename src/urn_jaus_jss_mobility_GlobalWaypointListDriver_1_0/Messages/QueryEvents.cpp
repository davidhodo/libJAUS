#include "urn_jaus_jss_mobility_GlobalWaypointListDriver_1_0/Messages/QueryEvents.h"

namespace urn_jaus_jss_mobility_GlobalWaypointListDriver_1_0
{

void QueryEvents::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void QueryEvents::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger QueryEvents::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int QueryEvents::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int QueryEvents::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void QueryEvents::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void QueryEvents::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
QueryEvents::MsgHeader::HeaderRec &QueryEvents::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool QueryEvents::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
QueryEvents::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x21f0;
}

QueryEvents::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
QueryEvents::MsgHeader::HeaderRec* const QueryEvents::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int QueryEvents::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void QueryEvents::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int QueryEvents::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void QueryEvents::MsgHeader::encode(unsigned char *bytes)
{
...
void QueryEvents::MsgHeader::decode(const unsigned char *bytes)
{
...
QueryEvents::MsgHeader &QueryEvents::MsgHeader::operator=(const MsgHeader &value)
{
...
bool QueryEvents::MsgHeader::operator==(const MsgHeader &value) const
{
...
QueryEvents::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

QueryEvents::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
QueryEvents::MsgHeader* const QueryEvents::getMsgHeader()
{
	return &m_MsgHeader;
}

int QueryEvents::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
