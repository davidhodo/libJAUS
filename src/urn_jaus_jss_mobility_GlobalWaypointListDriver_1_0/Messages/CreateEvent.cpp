#include "urn_jaus_jss_mobility_GlobalWaypointListDriver_1_0/Messages/CreateEvent.h"

namespace urn_jaus_jss_mobility_GlobalWaypointListDriver_1_0
{

void CreateEvent::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void CreateEvent::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger CreateEvent::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int CreateEvent::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int CreateEvent::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void CreateEvent::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void CreateEvent::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
CreateEvent::MsgHeader::HeaderRec &CreateEvent::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool CreateEvent::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
CreateEvent::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x01f0;
}

CreateEvent::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
CreateEvent::MsgHeader::HeaderRec* const CreateEvent::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int CreateEvent::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void CreateEvent::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int CreateEvent::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void CreateEvent::MsgHeader::encode(unsigned char *bytes)
{
...
void CreateEvent::MsgHeader::decode(const unsigned char *bytes)
{
...
CreateEvent::MsgHeader &CreateEvent::MsgHeader::operator=(const MsgHeader &value)
{
...
bool CreateEvent::MsgHeader::operator==(const MsgHeader &value) const
{
...
CreateEvent::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

CreateEvent::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
CreateEvent::MsgHeader* const CreateEvent::getMsgHeader()
{
	return &m_MsgHeader;
}

int CreateEvent::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
