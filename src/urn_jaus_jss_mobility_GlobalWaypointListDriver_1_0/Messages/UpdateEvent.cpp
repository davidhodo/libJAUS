#include "urn_jaus_jss_mobility_GlobalWaypointListDriver_1_0/Messages/UpdateEvent.h"

namespace urn_jaus_jss_mobility_GlobalWaypointListDriver_1_0
{

void UpdateEvent::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void UpdateEvent::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger UpdateEvent::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int UpdateEvent::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int UpdateEvent::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void UpdateEvent::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void UpdateEvent::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
UpdateEvent::MsgHeader::HeaderRec &UpdateEvent::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool UpdateEvent::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
UpdateEvent::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x01f1;
}

UpdateEvent::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
UpdateEvent::MsgHeader::HeaderRec* const UpdateEvent::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int UpdateEvent::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void UpdateEvent::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int UpdateEvent::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void UpdateEvent::MsgHeader::encode(unsigned char *bytes)
{
...
void UpdateEvent::MsgHeader::decode(const unsigned char *bytes)
{
...
UpdateEvent::MsgHeader &UpdateEvent::MsgHeader::operator=(const MsgHeader &value)
{
...
bool UpdateEvent::MsgHeader::operator==(const MsgHeader &value) const
{
...
UpdateEvent::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

UpdateEvent::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
UpdateEvent::MsgHeader* const UpdateEvent::getMsgHeader()
{
	return &m_MsgHeader;
}

int UpdateEvent::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
