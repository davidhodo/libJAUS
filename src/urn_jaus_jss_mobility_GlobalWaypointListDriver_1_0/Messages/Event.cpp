#include "urn_jaus_jss_mobility_GlobalWaypointListDriver_1_0/Messages/Event.h"

namespace urn_jaus_jss_mobility_GlobalWaypointListDriver_1_0
{

void Event::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void Event::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger Event::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int Event::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int Event::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void Event::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void Event::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
Event::MsgHeader::HeaderRec &Event::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool Event::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
Event::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x41f1;
}

Event::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
Event::MsgHeader::HeaderRec* const Event::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int Event::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void Event::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int Event::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void Event::MsgHeader::encode(unsigned char *bytes)
{
...
void Event::MsgHeader::decode(const unsigned char *bytes)
{
...
Event::MsgHeader &Event::MsgHeader::operator=(const MsgHeader &value)
{
...
bool Event::MsgHeader::operator==(const MsgHeader &value) const
{
...
Event::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

Event::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
Event::MsgHeader* const Event::getMsgHeader()
{
	return &m_MsgHeader;
}

int Event::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
